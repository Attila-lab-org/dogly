...
export const diaryEntriesMock: DiaryEntry[] = [
  ...
  },
  {
    ...
    subtitle: 'Confidenza media · Feedback: sì, è così',
  ...
  },
  {
    id: 'diary-fecal-flag',
    domain: 'DIGESTIVE',
    title: 'Digestione: possibile variazione',
    subtitle: 'Sembra più morbida del solito',
  ...
  },
  {
    id: 'diary-fecal-ok',
    domain: 'DIGESTIVE',
    title: 'Digestione: nella norma',
    subtitle: 'In linea con la baseline',
