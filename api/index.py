...
@app.post("/ops/recover-6d7c96f2", include_in_schema=False)
async def recover_stuck_behavior_runs() -> dict[str, list[str]]:
    """One-shot production recovery for the two runs created before the
    workflow consumer was deployed. Remove immediately after invocation."""
